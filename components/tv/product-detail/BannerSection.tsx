...
const BannerSection = ({
  ...
  <div className="-mx-4 sm:-mx-6 lg:-mx-10 max-w-480">
    <div key={banner.id} className="relative min-w-0 flex-[0_0_100%]">
      ...
      <div
        className={`relative flex flex-col justify-between gap-3 px-4 py-4 text-(--default-black-font) md:absolute md:inset-0 md:px-10 md:py-5 md:text-white lg:px-16 5xl:pt-28 5xl:px-28 ${
